...
def normalize_to_fixed_size(
    ...
    Returns:
        Normalized data array with shape [C, target_size]
    """
    import torch.nn.functional as F
...
def process_triplet(
    ...
    if os.path.isfile(out_sub_emb) and os.path.isfile(out_pre_aligned) and os.path.isfile(out_mask_aligned):
